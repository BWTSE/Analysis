...
variable_names_post <- posterior_predict(variable_names0.all, newdata = expand.grid
(high_debt_version = c("false", "true"), session = NA, var_names_new_all = 1:15))
...
### Needs fixing after Richards expand grid shenanigans.
