...
length(d.high) / length(d.low)
```
Given all the simulated cases we find that developers are `33%` more likely to leave incorrect documentation in the high debt version of the scenarios.
...
length(d.high) / length(d.low)
```
Given developers with 10 years of professional programming experience we find that they are `34%` more likely to leave incorrect documentation in the high debt version of the scenarios.
...
length(d.high) / length(d.low)
```
Given developers with 25 years of professional programming experience we find that they are `31%` more likely to leave incorrect documentation in the high debt version of the scenarios.
