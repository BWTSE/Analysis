...
```
Given all the simulated cases we find that they introduce `117%` more issues in the high debt version.
...
sum(d.high) / sum(d.low)
```
Considering developers with 10 years of professional programming experience we find that they introduce `120%` more issues in the high debt version.
...
sum(d.high) / sum(d.low)
```
Considering developers with no of professional programming experience we find that they introduce `115%` more issues in the high debt version.
...
sum(d.high) / sum(d.low)
```
Considering developers with 25 years of professional programming experience we find that they introduce `109%` more issues in the high debt version.
