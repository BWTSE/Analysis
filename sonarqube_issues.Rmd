...
mean(d.completed$sonarqube_issues)
var(d.completed$sonarqube_issues)
```
...
```{r}
sonarqube_issues1_scenario.poisson <- brm(
  sonarqube_issues ~ 1 
  + high_debt_version
  + scenario
  + (1 | session),
  ...
  iter = 5e3,
  #empty = TRUE
  file = "fits/sonarqube_issues1_scenario.poisson",
  file_refit = "on_change"
)

summary(sonarqube_issues1_scenario.poisson)
```
...
loo(
  sonarqube_issues0,
  sonarqube_issues1_scenario,
  sonarqube_issues0.poisson,
  sonarqube_issues1_scenario.poisson
)
```