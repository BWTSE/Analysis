...
```{r stuff, class.source = 'fold-show'}
print("All:")
mean(post.diff$estimate)

print("10 years:")
sum(pull(filter(post, work_experience_programming == 10, high_debt_version == "true"), estimate)) / sum(pull(filter(post, work_experience_programming == 10, high_debt_version == "false"), estimate))

print("25 years:")
sum(pull(filter(post, work_experience_programming == 25, high_debt_version == "true"), estimate)) / sum(pull(filter(post, work_experience_programming == 25, high_debt_version == "false"), estimate))
```
