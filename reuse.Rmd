...
d.completed %>%
  ...
  scale_fill_manual("Legend", values = c("lightblue", "darkblue"), labels = c("Reused", "Not reused")) +
...
The prior `lkj(2)` will mean the model is sceptical of strong correlations.
