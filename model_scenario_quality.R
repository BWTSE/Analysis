d.scqu = subset(d, task_completion_oc4 == 4)
d.scqu$prof_prog_exp_months.s = scale(d.scqu$prof_prog_exp_months)
d.scqu$prof_java_exp_months.s = scale(d.scqu$prof_java_exp_months)
