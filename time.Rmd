...
All models seems to have sampled nicely (rhat = 1 and fluffy plots) they also have about the same fit to the data end simila estimated for the high_debt_version beta parameter
...
We can see no "significant" relation between the abount of technical debt in the codebase and time spent on the task.
